...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findOrders() {
        ...
        List<OrderQueryDto> resultList = em.createQuery("select new jpabook.jpashop.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address)" +
                        " from Order o" +
                        " join o.member m" +
